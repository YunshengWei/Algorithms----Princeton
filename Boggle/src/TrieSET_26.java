/*************************************************************************
 *  Compilation:  javac TrieSET_26.java
 *  Execution:    java TrieSET_26 < words.txt
...
/**
 *  The <tt>TrieSET_26</tt> class represents an ordered set of strings over
 ...
 *  @author Kevin Wayne
 */
public class TrieSET_26 implements Iterable<String> {
    ...
    // This method is specific for BoggleSolver
    ...
    /**
     * Unit tests the <tt>TrieSET_26</tt> data type.
     */
    public static void main(String[] args) {
        TrieSET_26 set = new TrieSET_26();
        while (!StdIn.isEmpty()) {
